  ...
  return (
    <HeaderMotion>
      ...
      <HeaderMotion.FlatList
        ...
        onRefresh={onRefresh}
        progressViewOffset={CUSTOM_PROGRESS_VIEW_OFFSET}
      />
    </HeaderMotion>
  );
}
  ...
  return (
    <AnimatedHeaderBase
      ...
      style={[
        ...
        styles.translucentHeaderWrapper,
    ...
    >
      <Animated.View style={[titleStyle]}>
        <TitleWithSubtitle
          ...
          subtitle={`Custom progressViewOffset (${CUSTOM_PROGRESS_VIEW_OFFSET})`}
        />
      </Animated.View>
